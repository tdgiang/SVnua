...
export const DATA = [
  ...
  },
  {
    ...
    content: {
      image: null,
      text: 'K62CNPM Gấp! Gấp! Theo thông báo của Học viện, ngày mai phải có ds bạn cán sự lớp ngay và luôn, nên tối nay 20h (21/10/2020) lớp ta họp để thống nhất lại nhé. Nhờ các bạn trong lớp đọc được thông báo này báo các bạn trong lớp giúp cô. Hình thức họp là online qua Teams nhé.',
      file: null,
    },
    reply: [
      {
