...
const APIweather = 'https://api.openweathermap.org/data/2.5/weather?q=Hanoi&APPID=84f0c05e16abc57b03ca8fa00b59f78e&units=metric&fbclid=IwAR3PKoKgJSOZYFU-khGQGcbZU2XfGp3yVHE47UDe9pOAmprM8R7p0nXgTss';
...
const Header = (props) => {
  ...
  const getIconWeather = (type) => {
    switch (type) {
      case '01d': setIcon(R.images.day), setWeather('Trời nắng')
        break;
      case '01n': setIcon(R.images.night), setWeather('Buổi tối')
        break;

      case '03d': setIcon(R.images.cloud), setWeather('Nhiều mây')
        break;
      case '03n': setIcon(R.images.cloud), setWeather('Nhiều mây')
        break;

      case '09d': setIcon(R.images.rain), setWeather('Trời mưa')
        break;
      case '09n': setIcon(R.images.rain), setWeather('Trời mưa')
        break;
      case '10d': setIcon(R.images.rain), setWeather('Trời mưa')
        break;
      case '10n': setIcon(R.images.rain), setWeather('Trời mưa')
        break;

      default: setIcon(R.images.cool), setWeather('Trời mát')
      ...
      <ImageBackground
        ...
        <View style={{ flex: 1, paddingHorizontal: 20 }}>
          <View style={styles.row}>
            <Text style={styles.txtDate}>{getTime()[2]} tháng {getTime()[0]}</Text>
            <Image style={styles.icon} source={icon} />
          </View>
          <View style={styles.row}>
            <Text style={styles.txtWeek}>Thứ {getTime()[1]} tuần {getTime()[3]}</Text>
            <Text style={styles.txtWeek}>Hà Nội:{weather} {temp}°C</Text>
          </View>
        </View>
      </ImageBackground>
